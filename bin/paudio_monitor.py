...
def do_refresh():
    ...
    def print_things():
        ...
        print(f'{Fmt.BOLD}--- pAudio [{lspk}]{Fmt.END}')
        print()
        ...
        print(f'  {lspk_eq}')
        print()
        print(f'{Fmt.BOLD}Loudspeaker XO:{Fmt.END}')
        print(f'  {Fmt.ITALIC}(pending){Fmt.END}')
        print()
        print(f'{Fmt.BOLD}DRC{Fmt.END} (gain {drc_gain:5.1f} dB):')
        print('  L:', f'{drc_L_numberOfFilters:2d} x', f'{drc_L_typeOfFilters:<10}')
        print('  R:', f'{drc_R_numberOfFilters:2d} x', f'{drc_R_typeOfFilters:<10}')
        print()
        print(f'{Fmt.BOLD}--- CamillaDSP{Fmt.END} {Fmt.ITALIC}(ver: {cdsp_version} lib: {cdsp_lib_version}){Fmt.END}')
        print(f'  I/O:            {cap_dev} / {pbk_dev:<50}')
        print(f'  samplerate:     {samplerate:<6}')
        print(f'  buffer:         {chunk_size:<6}')
